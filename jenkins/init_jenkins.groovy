...
mp.getSourcesList().add(new BranchSource(new GitSCMSource(null, "https://github.com/ltutar/petclinic", "", "*", "", false), new DefaultBranchPropertyStrategy(new BranchProperty[0])));
